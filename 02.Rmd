...
```{r machine-learning,echo=FALSE,fig.cap='[Figure 1: How Potholes Form](http://www.summitengineer.net/resources/learning/52-potholes)',fig.align='right',out.width='50%'}
knitr::include_graphics('img/HowPotholesForm.png')
```
[cite summitengineer]

```{r machine-learning,echo=FALSE,fig.cap='[Figure 2: Number of potholes as a result of inches of snow](https://www.informs.org/ORMS-Today/Public-Articles/June-Volume-41-Number-3/POTHOLE-ANALYTICS)',fig.align='left',out.width='50%'}
